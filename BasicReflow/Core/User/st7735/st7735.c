...
// void ST7735_ALine(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t thickness, uint16_t color) {
//     // Check line bounds
...
// void ST7735_Arc(uint16_t x, uint16_t y, uint16_t r, uint16_t a0, uint16_t af) {
//     ST7735_Select();

//     // float arc_length = 3.1415926 * (af - a0) / 360 * r;


//     // Calculate bounding boxy of arc

// }

// void ST7735_VLine(uint16_t x1, uint16_t x2, uint16_t color) {
